...
const bloc = `      <div style={{background:'white',border:'1px solid '+CR.pale,borderRadius:12,padding:'1rem',marginBottom:'1rem'}}>
...
if (c.includes('temoignagesRevenus||TEMOIGNAGES_REVENUS_DEFAULT).map')) {
