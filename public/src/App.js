...
function ObjPersoTab({obj,save}){
  ...
  const resetPeriode=()=>{
    ...
    save({...obj,ca:"",recruesReal:"0",historique:nextHist});
  };
            ...
            {!obj?(
              ...
              <>
                ...
                {(() => {
                  ...
                  const compCA = comparaisonPeriode(hist, obj.ca, "ca");
                  const compR = comparaisonPeriode(hist, obj.recruesReal, "recruesReal");
                  return (
                    <>
                      {(compCA||compR)&&(
                      ...
                      <button onClick={()=>setExpanded(expanded===mid?null:mid)}
                        ...
                        {expanded===mid?"▲ Masquer la fiche détaillée":"▼ Voir la fiche détaillée"}
                      </button>
                      {expanded===mid&&(
  ...
  if (mode === "questionnaire") return (
    <div>
      ...
      <div style={{ fontFamily: "Georgia,serif", fontSize: "1.1rem", color: C.brun, marginBottom: ".3rem" }}>
        {type === "skincare" ? "✨ Diagnostic Skincare" : type === "cheveux" ? "💇 Diagnostic Cheveux" : "💊 Diagnostic Santé"}
