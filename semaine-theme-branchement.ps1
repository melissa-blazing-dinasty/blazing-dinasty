# =====================================================================
#  Blazing Dynasty - Branchement de l'onglet "Semaine a theme"
#  3 modifications dans App.js (import + sous-onglet + rendu)
#  Le contenu vit dans src/SemaineThemeTab.js
# =====================================================================
...
if (-not (Test-Path $mod)) {
    ...
    Write-Host "Copie-le d'abord :" -ForegroundColor Yellow
    Write-Host '  Copy-Item "$env:USERPROFILE\Downloads\SemaineThemeTab.js" "C:\Users\melou\blazing-dynasty\src\" -Force' -ForegroundColor Yellow
    exit 1
}
...
$a2 = '{id:"sprint",label:"' + [char]0x26A1 + ' Sprint"},'
...
$nouveau = '{id:"semainetheme",label:"' + [char]0x1F5D3 + [char]0xFE0F + ' Semaine a theme"},'
