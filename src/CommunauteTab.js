  ...
  return(
    <div>
      ...
      <div style={{display:"flex",gap:".4rem",marginBottom:"1rem"}}>
        {[{id:"partager",label:"✍️ Partager",icon:"✍️"},{id:"mur",label:"🏆 Mur de la gloire",icon:"🏆"},{id:"messages",label:"💬 Messages",icon:"💬"},{id:"banqueimages",label:"📸 Temoignages",icon:"📸"}].map(b=>(
