...
import { getPeriodeInfo, getPeriodeActuelle, fmtPLabel, Confetti, postToWallOfFame, CopyBtn, syncAnnuaire, computeBadges, BADGES_DEF, FAST_START_DAYS, MarrainePopup, AnnonceBanner, ConversionPopup, AssistanteIATab, JaugeSucces, BadgesPanel, CitationDuJour, BiblioActionsPopup, TodoPerso, ClassementEquipe, CmdPeriodeBlock, NoticePanel, FastStartTab, ObjectionsTab, ObjPersoTab, WallOfFameTab, SuiviCATab, HistoriquePeriodes } from './App';
